...
private val openApiJson = """
{
  ...
  "paths": {
    ...
    "/history/{id}/sync/strava": { "post": { "summary": "Upload completed workout to Strava" } },
    "/history/{id}/sync-status": { "get": { "summary": "Get Strava sync status" } },
    "/integrations/strava/status": { "get": { "summary": "Get Strava connection status" } },
    "/integrations/strava/connect-url": { "get": { "summary": "Create Strava OAuth authorization URL" } },
    "/integrations/strava/callback": { "get": { "summary": "Receive Strava OAuth callback", "security": [] } },
    "/integrations/strava/disconnect": { "post": { "summary": "Disconnect Strava" } },
